...
<div style="width:150px; height: 150px; border-radius:50%; background-image:url({{'assets/images/profiles/AlfonsoValencia.jpg' | relative_url}}); background-size: cover; background-repeat: no-repeat; background-position: center; float: left; margin: 15px 15px 15px 0px;"></div>
...
<div style="width:150px; height: 150px; border-radius:50%; background-image:url({{'assets/images/profiles/AndrewHercules.jpg' | relative_url}}); background-size: cover; background-repeat: no-repeat; background-position: center; float: left; margin: 15px 15px 15px 0px;"></div>
...
<div style="width:150px; height: 150px; border-radius:50%; background-image:url({{'assets/images/profiles/CeliavanGelder.jpg' | relative_url}}); background-size: cover; background-repeat: no-repeat; background-position: center; float: left; margin: 15px 15px 15px 0px;"></div>
...
<div style="width:150px; height: 150px; border-radius:50%; background-image:url({{'assets/images/profiles/JordiRambla.jpg' | relative_url}}); background-size: cover; background-repeat: no-repeat; background-position: center; float: left; margin: 15px 15px 15px 0px;"></div>
...
<div style="width:150px; height: 150px; border-radius:50%; background-image:url({{'assets/images/profiles/MichaelStadler.jpg' | relative_url}}); background-size: cover; background-repeat: no-repeat; background-position: center; float: left; margin: 15px 15px 15px 0px;"></div>
...
<div style="width:150px; height: 150px; border-radius:50%; background-image:url({{'assets/images/profiles/MichaelaThMayrhofer.jpg' | relative_url}}); background-size: cover; background-repeat: no-repeat; background-position: center; float: left; margin: 15px 15px 15px 0px;"></div>
...
<div style="width:150px; height: 150px; border-radius:50%; background-image:url({{'assets/images/profiles/PilarNicolas.jpg' | relative_url}}); background-size: cover; background-repeat: no-repeat; background-position: center; float: left; margin: 15px 15px 15px 0px;"></div>
...
<div style="width:150px; height: 150px; border-radius:50%; background-image:url({{'assets/images/profiles/SarahButcher.jpg' | relative_url}}); background-size: cover; background-repeat: no-repeat; background-position: center; float: left; margin: 15px 15px 15px 0px;"></div>
...
<div style="width:150px; height: 150px; border-radius:50%; background-image:url({{'assets/images/profiles/VeraMatser.jpg' | relative_url}}); background-size: cover; background-repeat: no-repeat; background-position: center; float: left; margin: 15px 15px 15px 0px;"></div>
